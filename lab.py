...
def animate_workspace_heatmap_forever(n_layers=100, dt=0.05,
    ...
    def update(frame):
        ...
        diag_b.set_text(
            ...
            f"LZ: {state_b['cached_lz']:.2f} | Why: {state_b.get('why', 0):.3f}\n"
            f"Step: {state_b['step_count']} | Frame: {time.perf_counter() - start_time:.3f}s"
        )
        ...
        max_step = max(state_a['step_count'], state_b['step_count'], state_c['step_count'])
        ...
        return heatmap_a, heatmap_b, heatmap_c, line_a, line_b, line_c, diag_a, diag_b, diag_c, perf_text, step_text
